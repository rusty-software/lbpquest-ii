...
export class SouthPondShore extends BaseLocation {
  ...
  public description(): string {
    let s =
      "You are on the south shore of the pond. The pond itself is not overly large, but certainly large and murky enough that you wouldn't seriously consider swimming it. The shoreline itself is mostly muddy dirt.";
  ...
  public sail(gameEngine: GameEngine): string {
    ...
    if (canoeHere && hasOar) {
      ...
      northShore.addItem(gameEngine, ItemKey.Canoe);

      let s =
        "You struck out from the south shore at a breakneck pace, aiming towards the north shore, and arrived mere moments later.";
      ...
      if (!gameEngine.getItem(ItemKey.CaptainsHat).taken) {
        ...
        hat.taken = true;
        s +=
          " On your way to the north shore, you slowed as you passed the branch sticking up in the middle of the pond. There was a captains hat hanging from it, which you promptly snatched and put into your duffle bag before continuing your journey.";
      }
      return s;
