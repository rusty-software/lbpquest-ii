...
export class Freezer extends BaseLocation {
  ...
  public pushLibraryButton(gameEngine: GameEngine) {
    return this.enterLocation(gameEngine, LocationKey.Library);
  }

  public pushWineryButton(gameEngine: GameEngine) {
    return this.enterLocation(gameEngine, LocationKey.Winery);
  }
